...
inline int ControlIndex(UINT16 control)
{
    return control < 50 ? 0 : 2;
}

enum class Context : UINT8
{
    Auto,
    Keyboard,
    Gamepad
...
enum class GamepadLabelStyle : UINT8
{
    Xbox,
    PlayStation
};
...
class KeybindEntry
{
  public:
    ...
    UINT16 KeyboardKey1() const
    {
        return m_keyboardKey1;
    }

    UINT16 KeyboardKey2() const
    {
        return m_keyboardKey2;
    }

    UINT16 GamepadButton1() const
    {
        return m_gamepadButton1;
    }

    UINT16 GamepadButton2() const
    {
        return m_gamepadButton2;
    }

    void SetKeyboardKey1(UINT16 value) const
    {
        m_keyboardKey1 = value;
    }

    void SetKeyboardKey2(UINT16 value) const
    {
        m_keyboardKey2 = value;
    }

    void SetGamepadButton1(UINT16 value) const
    {
        m_gamepadButton1 = value;
    }

    void SetGamepadButton2(UINT16 value) const
    {
        m_gamepadButton2 = value;
    }
