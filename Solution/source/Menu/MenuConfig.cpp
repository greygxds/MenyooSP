...
void MenuConfig::ConfigRead()
{
    ...
    sub::Spooner::Settings::bTeleportToReferenceWhenLoadingFile =
        ini.GetBoolValue(section_spooner.c_str(), "TeleportToReferenceWhenLoadingFile", sub::Spooner::Settings::bTeleportToReferenceWhenLoadingFile);
...
void MenuConfig::SaveConfig()
{
    ...
    const char* legacyBinds[][2] = {
        {"settings", "open_key"},
        {"settings", "open_button_for_gamepad_1"},
        {"settings", "open_button_for_gamepad_2"},
        {"settings", "manual_respawn_button"},
        {"settings", "stop_animation_key"},
        {"settings", "tp_to_wp_key"},
        {"settings", "tp_to_wp_pad"},
        {"settings", "category_nav_key"},
        {"settings", "category_nav_pad"},
        {"general", "FreeCamButton"},
        {"general", "tow_key"},
        {"general", "tow_pad"},
        {"general", "MenuActionHotkey"},
        {"general", "FreeCamPad_1"},
        {"general", "FreeCamPad_2"},
        {"object-spooner", "SpoonerModeHotkey"},
        {"object-spooner", "SpoonerModeGamepadBind_1"},
        {"object-spooner", "SpoonerModeGamepadBind_2"},
        {"object-spooner", "SpoonerMarkerHotkey"},
        {"object-spooner", "SpoonerMarkerPad"},
        {"object-spooner", "SpoonerEditModeHotkey"},
        {"object-spooner", "SpoonerEditCopyHotkey"},
        {"object-spooner", "SpoonerEditTransformHotkey"},
        {"object-spooner", "SpoonerEditCamLockHotkey"},
...
void MenuConfig::FlushPendingSave(bool force)
{
    if (!savePending)
        return;
    if (!force && GetTickCount() - lastSaveRequest < pendingSaveDelayMs)
        return;
