...
namespace RopeGun
{
EntitiesAndRope::EntitiesAndRope() : rope(0), e1(0), e2(0), initialDistance(0.0f)
{
}

EntitiesAndRope::EntitiesAndRope(const Rope& ropeP, const GTAentity& e1P, const GTAentity& e2P, float initialDistanceP) : rope(ropeP), e1(e1P), e2(e2P), initialDistance(initialDistanceP)
{
}

EntitiesAndRope::EntitiesAndRope(const EntitiesAndRope& obj) : rope(obj.rope), e1(obj.e1), e2(obj.e2), initialDistance(obj.initialDistance)
{
}
...
RopeGun::RopeGun() : whash(WEAPON_HEAVYPISTOL), shootCount(0Ui8)
{
}
