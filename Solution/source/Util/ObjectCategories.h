...
inline Category GetObjectCategory(const std::string& modelName)
{
    ...
    if (StartsWithAny(name, {"prop_cash", "prop_gold", "prop_jewel"}) || ContainsAny(name, {"_cash", "_money", "_gold", "_jewel", "_loot", "_safe"}))
        return LootValuables;

    if (StartsWithAny(name, {"prop_food", "prop_beer", "prop_vend", "prop_champ", "prop_bar"}) || ContainsAny(name, {"_food", "_beer", "_wine", "_bottle", "_drink", "_coffee"}))
...
inline const char* GetObjectCategoryName(Category cat)
{
    ...
    case Interiors:
        return "Interiors/Shells";
    case WeaponsAndPickups:
        return "Weapons/Pickups";
    case FurnitureAndDecor:
        return "Furniture/Decor";
    case DoorsWindowsBuildings:
        return "Doors/Windows/Buildings";
    case BarriersFencesGates:
        return "Barriers/Fences/Gates";
    case SignsTrafficStreet:
        return "Signs/Traffic/Street";
    case NatureLandscape:
        return "Nature/Landscape";
    case ConstructionIndustrial:
        return "Construction/Industrial";
    case UtilityElectrical:
        return "Utility/Electrical";
    case StorageCargo:
        return "Storage/Cargo";
    case FoodDrinkRetail:
        return "Food/Drink/Retail";
    case TrashDebris:
        return "Trash/Debris";
    case Vehicles_Parts:
    ...
    case RacingStunt:
        return "Racing/Stunt";
    case BeachLeisureSports:
        return "Beach/Leisure/Sports";
    case LootValuables:
        return "Loot/Valuables";
    case CharacterWearables:
        return "Character/Wearables";
    case Missions:
        return "Mission/Scripted";
    case VfxLod:
        return "VFX/LOD/Proxy";
    case Specialized:
...
inline DlcGroup GetObjectDlcGroup(const std::string& modelName)
{
    ...
    if (StartsWith(name, "hei_"))
        return DLC_Heists;
    if (StartsWithAny(name, {"apa_", "ex_"}))
        return DLC_Executives;
    if (StartsWith(name, "imp_"))
        return DLC_ImportExport;
    if (StartsWith(name, "bkr_"))
        return DLC_Bikers;
    if (StartsWith(name, "gr_"))
        return DLC_Gunrunning;
    if (StartsWith(name, "sm_"))
        return DLC_SmugglersRun;
    if (StartsWithAny(name, {"xm_", "xm3_"}))
        return DLC_Doomsday;
    if (StartsWith(name, "ba_"))
        return DLC_AfterHours;
    if (StartsWithAny(name, {"ar_", "as_", "xs_"}))
        return DLC_ArenaWar;
    if (StartsWith(name, "vw_"))
        return DLC_DiamondCasino;
    if (StartsWith(name, "ch_"))
        return DLC_DiamondCasinoHeist;
    if (StartsWith(name, "h4_"))
        return DLC_CayoPerico;
    if (StartsWith(name, "lr_"))
        return DLC_Lowriders;
    if (StartsWithAny(name, {"sr_", "stt_"}))
        return DLC_SpecialRaces;
    if (StartsWith(name, "sum_"))
        return DLC_Nightclub;
    if (StartsWith(name, "sf_"))
        return DLC_Mercenaries;
    if (StartsWith(name, "m23_"))
        return DLC_Missions2023;
    if (StartsWith(name, "m24_"))
        return DLC_Missions2024;
    if (StartsWith(name, "m25_"))
        return DLC_Missions2025;
    if (StartsWithAny(name, {"tr_", "reh_", "lts_"}))
        return DLC_Other;
...
inline const char* GetObjectDlcGroupName(DlcGroup group)
{
    ...
    {
    case BaseGame:
        return "Base Game/Core";
    case DLC_Heists:
        return "Heists";
    case DLC_Executives:
        return "Executives/Apartments";
    case DLC_ImportExport:
    ...
    case DLC_Doomsday:
        return "Doomsday/xm";
    case DLC_AfterHours:
        return "After Hours/Nightclub";
    case DLC_ArenaWar:
        return "Arena War";
    case DLC_DiamondCasino:
        return "Diamond Casino";
    case DLC_DiamondCasinoHeist:
        return "Casino Heist";
    case DLC_CayoPerico:
        return "Cayo Perico";
    case DLC_Lowriders:
        return "Lowriders";
    case DLC_SpecialRaces:
        return "Special/Stunt Races";
    case DLC_Nightclub:
        return "Nightclub/Business";
    case DLC_Mercenaries:
        return "Mercenaries/Sandy Shores";
    case DLC_Missions2023:
        return "Mission Props 2023";
    case DLC_Missions2024:
        return "Mission Props 2024";
    case DLC_Missions2025:
        return "Mission Props 2025";
    case DLC_Other:
        return "Other DLC";
    default:
        return "Unknown";
...
inline const char* GetStuntTypeName(StuntType type)
{
    ...
    case Stunt_Ramps:
        return "Ramps/Jumps";
    case Stunt_Tubes:
        return "Tubes/Tunnels";
    case Stunt_Loops:
        return "Loops";
    case Stunt_Spirals:
        return "Spirals";
    case Stunt_Rings:
        return "Rings/Gates/Hoops";
    case Stunt_Checkpoints:
        return "Checkpoints";
    case Stunt_TrackPieces:
        return "Track Pieces";
    case Stunt_Wallrides:
        return "Wallrides";
    case Stunt_BuildingBlocks:
        return "Building Blocks";
    case Stunt_BoostPads:
        return "Boost/Speed Pads";
    case Stunt_Barriers:
        return "Barriers/Tyre Walls";
    case Stunt_ArenaHazards:
        return "Arena Hazards";
    case Stunt_StartFinish:
        return "Start/Finish Lines";
    case Stunt_Pickups:
        return "Pickups/Items";
    case Stunt_Targets:
        return "Targets";
    case Stunt_Skatepark:
        return "Skatepark";
    default:
        return "Not Stunt";
    }
...
inline SizeClass GetNamedSize(const std::string& modelName)
{
    ...
    if (ContainsAny(name, {"_xxs"}))
        return Size_XXS;
    if (ContainsAny(name, {"_xxl"}))
        return Size_XXL;
    if (ContainsAny(name, {"_huge"}))
        return Size_Huge;

    if (name.length() > 2)
    {
        if (ContainsAny(name, {"_xs"}) && !ContainsAny(name, {"_xs_0", "txs", "exs"}))
            return Size_XS;
        if (ContainsAny(name, {"_xl"}) && !ContainsAny(name, {"_xl_0", "txl"}))
            return Size_XL;

        if (ContainsAny(name, {"_sml", "_small"}))
            return Size_S;
        if (ContainsAny(name, {"_mdm", "_medium"}))
            return Size_M;
        if (ContainsAny(name, {"_lrg", "_large"}))
            return Size_L;
        ...
        if (len >= 2)
        {
            ...
            if (last2 == "_s" || last2 == "sb")
                return Size_S;
            if (last2 == "_m" || last2 == "mb")
                return Size_M;
            if (last2 == "_l" || last2 == "lb")
                return Size_L;
        }
    }
