...
bool IsSafePath(const std::string& path)
{
    ...
    static const char* const reservedNames[] = {"CON",  "PRN",  "AUX",  "NUL",  "COM1", "COM2", "COM3", "COM4", "COM5", "COM6", "COM7",
    ...
    if (path.front() == ' ' || path.back() == ' ' || path.back() == '.')
        return false;
