...
template <typename T> Hook<T>::~Hook()
{
}

template <typename T> class CallHook : public Hook<T>
{
  public:
...
{
  public:
    template <typename T> static inline CallHook<T> *SetCall(uintptr_t address, T target)
    {
