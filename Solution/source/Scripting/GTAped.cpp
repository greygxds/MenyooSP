...
{
    return !this->IsInjured() && !this->IsRagdoll() && !this->IsInAir() && !this->IsOnFire() && !this->IsDucking() && !this->IsGettingIntoAVehicle() && !this->IsInCombat() &&
           !this->IsInMeleeCombat() && !this->IsInVehicle();
}
