...
const std::vector<std::string> WeaponIndivs::vCategoryNames{
    "Melee", "Pistols", "Submachine Guns", "Machine Guns", "Assault Rifles", "Shotguns", "Sniper Rifles", "Heavy Weapons", "Throwable Weapons", "Add-on Weapons"
};
...
const std::vector<std::string> WeaponIndivs::vCaptions_TintsMk2{
    {"Classic Black"},        {"Classic Gray"},          {"Classic Two-Tone"},      {"Classic White"},        {"Classic Beige"},         {"Classic Green"},          {"Classic Blue"},
    {"Classic Earth"},        {"Classic Brown & Black"}, {"Red Contrast"},          {"Blue Contrast"},        {"Yellow Contrast"},       {"Orange Contrast"},        {"Bold Pink"},
    {"Bold Purple & Yellow"}, {"Bold Orange"},           {"Bold Green & Purple"},   {"Bold Red Features"},    {"Bold Green Features "},  {"Bold Cyan Features"},     {"Bold Yellow Features"},
    {"Bold Red & White"},     {"Bold Blue & White"},     {"Metallic Gold"},         {"Metallic Platinum"},    {"Metallic Gray & Lilca"}, {"Metallic Purple & Lime"}, {"Metallic Red"},
    {"Metallic Green"},       {"Metallic Blue"},         {"Metallic White & Aqua"}, {"Metallic Red & Yellow"}
};
...
std::vector<WeaponAndComponents> WeaponIndivs::wc_MELEE{
    ...
    {WEAPON_STUNROD, {}, &WeaponIndivs::vCaptions_Tints},
};
#pragma endregion
...
std::vector<WeaponAndComponents> WeaponIndivs::wc_HEAVY{
    ...
    {WEAPON_RAILGUNXM3,
     ...
     &WeaponIndivs::vCaptions_Tints},
    {WEAPON_SNOWLAUNCHER, {}, &WeaponIndivs::vCaptions_Tints},
};
#pragma endregion
