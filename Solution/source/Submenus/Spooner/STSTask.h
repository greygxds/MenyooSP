...
{
    return std::find_if(vSTSTaskTypeNames.cbegin(), vSTSTaskTypeNames.cend(), [&b](const std::pair<STSTaskType, std::pair<std::string, EntityType>>& a) -> bool { return a.first == b; });
}
