...
SpoonerLight::SpoonerLight()
    : m_id(++iLightIdIter), m_name("Light"), m_lightType(LightType::Omni), m_active(true), m_selectedInSub(false), m_colour(255, 255, 255, 255), m_position(), m_range(10.0f), m_intensity(1.0f),
      m_direction(0, 0, -1), m_spotDistance(20.0f), m_spotBrightness(1.0f), m_spotRoundness(0.0f), m_spotRadius(7.5f), m_spotFalloff(0.0f), m_useShadow(false), m_shadowId(0)
{
}

SpoonerLight::SpoonerLight(const Vector3& position, const Vector3& direction)
    : m_id(++iLightIdIter), m_name("Light"), m_lightType(LightType::Omni), m_active(true), m_selectedInSub(false), m_colour(255, 255, 255, 255), m_position(position), m_range(10.0f),
      m_intensity(1.0f), m_direction(direction), m_spotDistance(20.0f), m_spotBrightness(1.0f), m_spotRoundness(0.0f), m_spotRadius(7.5f), m_spotFalloff(0.0f), m_useShadow(false), m_shadowId(0)
{
}
