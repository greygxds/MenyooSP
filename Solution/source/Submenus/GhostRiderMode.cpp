...
GhostRiderMode::GhostRiderMode()
    : freakOutDict("ANIM@MP_PLAYER_INTUPPERFREAKOUT"), freakOutName("EXIT_FP"), fxDataPurpleSmoke("scr_rcbarry2", "scr_clown_appears"), fxDataFireTrail("scr_martin1", "scr_sol1_fire_trail"),
      fxHead2(fxDataPurpleSmoke), fxHandLeft(fxDataPurpleSmoke), fxHandRight(fxDataPurpleSmoke), fxCarWheelFrontLeft(fxDataFireTrail), fxCarWheelFrontRight(fxDataFireTrail),
      fxCarWheelRearLeft(fxDataFireTrail), fxCarWheelRearRight(fxDataFireTrail),

      tyreScale(-2.00f), headScale(0.075f), handScale(0.045f), tyreRot(-91.06, 0, -90.0f), headRot(-90.0f, 0, -90.0f), handRot(-90.0f, 0, -90.0f)
{
}
