...
void AttachObjectToVehicle(
    GTAmodel::Model model, GTAvehicle vehicle, float X, float Y, float Z, float Pitch, float Roll, float Yaw, bool invis, int boneIndex, bool dynamic, bool collisionEnabled, bool destroyVar
)
{
    if (vehicle.Exists())
    {
        ...
        if (collisionEnabled)
            object.SetIsCollisionEnabled(collisionEnabled);
        if (destroyVar)
            SET_OBJECT_AS_NO_LONGER_NEEDED(&object.Handle());
    }
}

void AttachVehicleToVehicle(
    GTAmodel::Model model, GTAvehicle vehicle, int primColour, int secColour, float X, float Y, float Z, float Pitch, float Roll, float Yaw, bool invis, int boneIndex, bool collisionEnabled
)
{
    if (vehicle.Exists())
    {
...
void Feltzeruma()
{
    ...
    AttachVehicleToVehicle(
        VEHICLE_KURUMA2, vehicle, VehicleColoursMatte::COLOR_MATTE_LIME_GREEN, VehicleColoursMatte::COLOR_MATTE_SCHAFTER_PURPLE, 0, -0.1530f, 0.0770f, 0, 0, 0, false, bone_bodyshell
    );
...
void Bulletuma()
{
    ...
    AttachVehicleToVehicle(
        VEHICLE_KURUMA2, vehicle, VehicleColoursClassic::COLOR_CLASSIC_GALAXY_BLUE, VehicleColoursMatte::COLOR_MATTE_BLACK, 0, -0.1900f, 0.2600f, 1.5200f, 0, 0, false, bone_bodyshell
    );
...
void LandJetski()
{
    ...
    AttachVehicleToVehicle(
        VEHICLE_SEASHARK2, vehicle, VehicleColoursClassic::COLOR_CLASSIC_PURE_WHITE, VehicleColoursClassic::COLOR_CLASSIC_CANDY_RED, 0, -0.1800f, -0.4600f, 0, 0, 0, false, bone_bodyshell
    );
...
void MonsterTruckHelicopterChassis()
{
    ...
    AttachVehicleToVehicle(
        VEHICLE_SAVAGE, vehicle, VehicleColoursMatte::COLOR_MATTE_MIDNIGHT_PURPLE, VehicleColoursMatte::COLOR_MATTE_MIDNIGHT_PURPLE, 0, -0.2400f, 0.3100f, 0, 0, 0, false, bone_bodyshell, true
    );
...
void MonsterTruckRVChassis()
{
    ...
    AttachVehicleToVehicle(
        VEHICLE_JOURNEY, vehicle, VehicleColoursMatte::COLOR_MATTE_MIDNIGHT_BLUE, VehicleColoursMatte::COLOR_MATTE_MIDNIGHT_BLUE, 0, 0.2000f, 0.6400f, 0, 0, 0, false, bone_bodyshell, true
    );
...
void RVBuilding()
{
    ...
    AttachVehicleToVehicle(
        VEHICLE_JOURNEY, vehicle, VehicleColoursClassic::COLOR_CLASSIC_PURE_WHITE, VehicleColoursClassic::COLOR_CLASSIC_PURE_WHITE, 0, 0, 2.2560f, 0, 0, 0, false, bone_bodyshell, true
    );
    AttachVehicleToVehicle(
        VEHICLE_JOURNEY, vehicle, VehicleColoursClassic::COLOR_CLASSIC_PURE_WHITE, VehicleColoursClassic::COLOR_CLASSIC_PURE_WHITE, 0, 0, 2.2560f * 2.0f, 0, 0, 0, false, bone_bodyshell, true
    );
