...
const std::vector<GarageInteriorOption> vFloorOptions // For Autoshop
    {
        {"None", "Floor_vinyl_00"}, {"1", "Floor_vinyl_01"},  {"2", "Floor_vinyl_02"},  {"3", "Floor_vinyl_03"},  {"4", "Floor_vinyl_04"},  {"5", "Floor_vinyl_05"},  {"6", "Floor_vinyl_06"},
        {"7", "Floor_vinyl_07"},    {"8", "Floor_vinyl_08"},  {"9", "Floor_vinyl_09"},  {"10", "Floor_vinyl_10"}, {"11", "Floor_vinyl_11"}, {"12", "Floor_vinyl_12"}, {"13", "Floor_vinyl_13"},
        {"14", "Floor_vinyl_14"},   {"15", "Floor_vinyl_15"}, {"16", "Floor_vinyl_16"}, {"17", "Floor_vinyl_17"}, {"18", "Floor_vinyl_18"}, {"19", "Floor_vinyl_19"}, {"20", "Floor_vinyl_20"},
    };
const std::vector<GarageInteriorOption> vDecorOptions{
    {"None", "Garage_Decor_00"}, {"1", "Garage_Decor_01"},  {"2", "Garage_Decor_02"},  {"3", "Garage_Decor_03"},  {"4", "Garage_Decor_04"},  {"5", "Garage_Decor_05"},  {"6", "Garage_Decor_06"},
    {"7", "Garage_Decor_07"},    {"8", "Garage_Decor_08"},  {"9", "Garage_Decor_09"},  {"10", "Garage_Decor_10"}, {"11", "Garage_Decor_11"}, {"12", "Garage_Decor_12"}, {"13", "Garage_Decor_13"},
    {"14", "Garage_Decor_14"},   {"15", "Garage_Decor_15"}, {"16", "Garage_Decor_16"}, {"17", "Garage_Decor_17"}, {"18", "Garage_Decor_18"}, {"19", "Garage_Decor_19"}, {"20", "Garage_Decor_20"},
};
const std::vector<GarageInteriorOption> vLightingOptions{
    {"None", "Lighting_Option00"}, {"1", "Lighting_Option01"},  {"2", "Lighting_Option02"},  {"3", "Lighting_Option03"},  {"4", "Lighting_Option04"},  {"5", "Lighting_Option05"},
    {"6", "Lighting_Option06"},    {"7", "Lighting_Option07"},  {"8", "Lighting_Option08"},  {"9", "Lighting_Option09"},  {"10", "Lighting_Option10"}, {"11", "Lighting_Option11"},
    {"12", "Lighting_Option12"},   {"13", "Lighting_Option13"}, {"14", "Lighting_Option14"}, {"15", "Lighting_Option15"}, {"16", "Lighting_Option16"}, {"17", "Lighting_Option17"},
    {"18", "Lighting_Option18"},   {"19", "Lighting_Option19"}, {"20", "Lighting_Option20"},
};
const std::vector<GarageInteriorOption> vNumStyleOptions // _N1/_N2/_N3
    {
        {"None", "Numbering_Style00"}, {"1", "Numbering_Style01"},  {"2", "Numbering_Style02"},  {"3", "Numbering_Style03"},  {"4", "Numbering_Style04"},  {"5", "Numbering_Style05"},
        {"6", "Numbering_Style06"},    {"7", "Numbering_Style07"},  {"8", "Numbering_Style08"},  {"9", "Numbering_Style09"},  {"10", "Numbering_Style10"}, {"11", "Numbering_Style11"},
        {"12", "Numbering_Style12"},   {"13", "Numbering_Style13"}, {"14", "Numbering_Style14"}, {"15", "Numbering_Style15"}, {"16", "Numbering_Style16"}, {"17", "Numbering_Style17"},
        {"18", "Numbering_Style18"},   {"19", "Numbering_Style19"}, {"20", "Numbering_Style20"},
    };
