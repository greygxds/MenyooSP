...
const std::vector<std::string> vTheTongvaEstateShell{"hei_ch1_09_mansion_generic", "hei_ch1_09_mansion_private"};
const std::vector<std::string> vTheTongvaEstateRailing{"hei_ch1_09_mansion_railings_m", "hei_ch1_09_mansion_railings_p"};
const std::vector<std::string> vTheTongvaEstateShutters{"hei_ch1_09_mansion_shutters"};
const std::vector<std::string> vTheTongvaEstateCustom{"hei_ch1_09_mansion_furniture", "hei_ch1_09_mansion_firepit", "m25_2_tongva_mansion_gym", "m25_2_tongva_dog_house"};
...
const std::vector<std::string> vTheVinewoodResidenceRemove{"apa_ch2_04_mansion_original", "apa_ch2_04_props_original", "apa_ch2_04_mansion_grass"};
const std::vector<std::string> vTheVinewoodResidenceShell{"apa_ch2_04_mansion_generic", "apa_ch2_04_mansion_private"};
const std::vector<std::string> vTheVinewoodResidenceRailing{"apa_ch2_04_mansion_railings_m", "apa_ch2_04_mansion_railings_p"};
const std::vector<std::string> vTheVinewoodResidenceShutters{"apa_ch2_04_mansion_shutters"};
const std::vector<std::string> vTheVinewoodResidenceCustom{"apa_ch2_04_mansion_furniture", "apa_ch2_04_mansion_firepit", "m25_2_east_mansion_gym", "m25_2_east_dog_house"};
...
const std::vector<std::string> vRichmanVillaRemove{"hei_ch1_06e_mansion_original", "hei_ch1_06f_mansion_original", "hei_ch1_06e_props_original", "hei_ch1_roads_original"};
const std::vector<std::string> vRichmanVillaShell{"hei_ch1_06e_mansion_generic", "hei_ch1_06e_mansion_private"};
const std::vector<std::string> vRichmanVillaRailing{"hei_ch1_06e_mansion_railings_m", "hei_ch1_06e_mansion_railings_p"};
const std::vector<std::string> vRichmanVillaShutters{"hei_ch1_06e_mansion_shutters"};
const std::vector<std::string> vRichmanVillaCustom{"hei_ch1_06e_mansion_furniture", "hei_ch1_06e_mansion_firepit", "m25_2_mansion_gym", "m25_2_dog_house"};
...
const std::vector<MansionInteriorOption> vseasonalOptions{
    {"None", "", 0}, {"Afterparty", "SET_AFTERPARTY", 0}, {"Birthday", "SET_BIRTHDAY", 0}, {"Halloween", "SET_HALLOWEEN", 0}, {"Lunar", "SET_LUNAR", 0}, {"Xmas", "SET_XMAS", 0}
};

const std::vector<MansionInteriorOption> vstyleOptions{
    {"None", "", 0}, {"San Andreas Coastal", "SET_STYLE_CALI", 0}, {"Vinewood Regency", "SET_STYLE_HOLLY", 0}, {"Los Santos Loft", "SET_STYLE_LOFT", 0}
};

const std::vector<MansionInteriorOption> vpetsOptions{{"None", "", 0}, {"Cat", "SET_PET_CAT", 0}, {"Dog", "SET_PET_DOG", 0}};
...
const std::vector<MansionInteriorOption> vassistantOptions{{"None", "", 0}, {"OG", "SET_AI_TABLETS_01", 0}, {"Haviland", "SET_AI_TABLETS_02", 0}, {"Angel", "SET_AI_TABLETS_03", 0}};

const std::vector<MansionInteriorOption> vartOptions{
    {"None", "", 0}, {"San Andreas Coastal", "SET_ART_COASTAL", 0}, {"Los Santos Loft", "SET_ART_LOFT", 0}, {"Vinewood Regency", "SET_ART_REGENCY", 0}
};

const std::vector<MansionInteriorOption> vmichaelOptions{{"None", "", 0}, {"Card", "SET_MICHAEL_CARD", 0}, {"Poster", "SET_MICHAEL_POSTER", 0}};

const std::vector<MansionInteriorOption> velevatorOptions{
    {"None", "", 0}, {"San Andreas Coastal", "SET_ELEV_CALI", 0}, {"Los Santos Loft", "SET_ELEV_LOFT", 0}, {"Vinewood Regency", "SET_ELEV_HOLLY", 0}
};
...
const std::vector<MansionLocation> vLocations{
    {"Richman Villa",
     {-1666.36f, 478.92f, 128.22f},
     {-1649.63f, 480.97f, 117.36f},
     {-1679.87f, 493.59f, 56.45f},
     vRichmanVillaLoad,
     vRichmanVillaRemove,
     vRichmanVillaShell,
     vRichmanVillaRailing,
     vRichmanVillaShutters,
     vRichmanVillaCustom},
    {"The Vinewood Residence",
     {539.7012f, 749.089f, 201.36f},
     {547.4955f, 734.136f, 190.5f},
     {548.6964f, 766.88f, 186.07f},
     vTheVinewoodResidenceLoad,
     vTheVinewoodResidenceRemove,
     vTheVinewoodResidenceShell,
     vTheVinewoodResidenceRailing,
     vTheVinewoodResidenceShutters,
     vTheVinewoodResidenceCustom},
    {"The Tongva Estate",
     {-2586.065f, 1909.995f, 166.37f},
     {-2587.495f, 1893.193f, 155.51f},
     {-2568.933f, 1920.202f, 151.08f},
     vTheTongvaEstateLoad,
     vTheTongvaEstateRemove,
     vTheTongvaEstateShell,
     vTheTongvaEstateRailing,
     vTheTongvaEstateShutters,
     vTheTongvaEstateCustom}
};
