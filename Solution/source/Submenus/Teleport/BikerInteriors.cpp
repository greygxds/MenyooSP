...
const std::vector<BusinessLocation> vLocations{
    ...
    {"Weed Farm",
     {1049.6000f, -3196.6000f, -38.5000f},
    ...
    {"Counterfeit Cash Factory",
     {1124.6000f, -3196.6000f, -38.5000f},
     "bkr_biker_interior_placement_interior_5_biker_dlc_int_ware04_milo_",
     {"counterfeit_standard_equip", "dryerc_on", "dryerd_on", "counterfeit_upgrade_equip", "counterfeit_low_security", "counterfeit_security"}},
...
void Sub_Businesses_InLoc()
{
    ...
    bool bOption_plus = false, bOption_minus = false;
    AddTexter(
        "Option", 0, std::vector<std::string>{currentBusinessInfo.option == 0 ? "Empty" : currentBusinessInfo.location->options[currentBusinessInfo.option - 1]}, null, bOption_plus, bOption_minus
    );
    if (bOption_plus)
    {
