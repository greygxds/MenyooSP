...
const std::vector<TeleLocation> vOtherFacilityRelatedTeleports{
    ...
    TeleLocation(
        ...
        {},
        {"shell_tint"_sv, "CONTROL_1"_sv, "CONTROL_2"_sv, "CONTROL_3"_sv, "WEAPONS_MOD"_sv, "VEHICLE_MOD"_sv, "GOLD_BLING"_sv},
        true,
        false,
        true
    )
...
struct FacilityInfoStructure
{
    ...
    struct FacilityInteriorOptionIndex
    {
        ...
        FacilityInteriorOptionIndex(int indeX) : index(indeX), currTint(1U)
        {
        }

        FacilityInteriorOptionIndex() : index(0U), currTint(1U)
        {
        }
