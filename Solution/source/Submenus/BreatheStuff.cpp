...
{
const std::vector<std::pair<std::string, BreathePtfxType>> captionsBreatheStuff{{"None", BreathePtfxType::None}, {"Bloody Puke", BreathePtfxType::Blood}, {"Fire", BreathePtfxType::Fire}};
...
{
    null = 0;
    AddTickol(text, type == playerBreatheStuff, null, null);
    if (null)
    {
